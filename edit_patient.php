		...
		<div id="leftable">
			<table border="1">
				...
				<tr>
					...
					<td><input type='text' name="usernamePatient" placeholder='New Name' required='required' disabled="disabled" value="<?php echo $row->username; ?>" id="usernamePatient" onclick="disableTextBox()"/></td>
				</tr>
