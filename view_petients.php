...
<tr>
		...
		<td><a href="editPatient.php?username=<?php echo $row->username;?>&submit=Submit">Edit</a></td>
		<td><a href="deletePatient.php?username=<?php echo $row->username;?>&submit=Submit">Delete</a></td>
</tr>
<?php
		}
?></table></center>
